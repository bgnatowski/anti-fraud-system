...
//		given(userManager.registerUser(registrationRequest, confirmationCode)).willReturn(userDTO);
//
//		// When Then
...
//		given(userManager.addUserAddress("johndoe",addressRegisterRequest)).willReturn(userDTO);
//
//		// When Then
...
//				new PhoneNumberDTO("+48123123123"));
//
//		given(userManager.getUserByUsername("johndoe")).willReturn(userDTO);
//
//		// When Then
...
//		given(userManager.changeRole(roleUpdateRequest)).willReturn(userDTO);
//
//		// When Then
...
//		given(userManager.changeLock(unlockRequest)).willReturn(new UserUnlockResponse(result));
//
//		// When Then
...
//		// Given
//		given(userManager.getAllRegisteredUsers()).willReturn(new ArrayList<>());
//		// When Then
...
//		String username = "johndoe";
//
//		given(userManager.deleteUserByUsername(username))
