...
import pl.bgnat.antifraudsystem.bank.user.dto.response.UserAccountCreatedResponse;
import pl.bgnat.antifraudsystem.bank.user.dto.response.UserCreditCardCreatedResponse;
import pl.bgnat.antifraudsystem.bank.user.dto.response.UserDeleteResponse;
import pl.bgnat.antifraudsystem.bank.user.dto.response.UserWithAddressResponse;
...
class UserCRUDController {
	...
	@GetMapping("/users") // admin/support - kiedy chce sprawdzić czy np jest takie konto -> potem sobie filtruje
	...
	@PostMapping("/user") // rejestracja każdego
	...
	@PatchMapping("/user/{username}/address/create") // merchant -  admin/support nie musi miec przypisanego
