...
class UserManager {
    ...
    UserWithAddressResponse addUserAddress(String username, AddressRegisterRequest addressRegisterRequest) {
        ...
        return UserWithAddressResponse.builder()
                ...
                .addressDTO(addressService.mapToDto(user.getAddress()))
                .build();
    }
    ...
    UserAccountCreatedResponse createAccountForUserWithUsername(String username) {
        ...
        return UserAccountCreatedResponse.builder()
                .userDTO(userService.mapToDto(user))
                .accountDTO(accountService.mapToDto(newAccount))
                .build();
    }
    ...
    UserCreditCardCreatedResponse createCreditCardForUserWithUsername(String username) {
        ...
        return UserCreditCardCreatedResponse.builder()
                .userDTO(userService.mapToDto(user))
                .accountDTO(accountService.mapToDto(user.getAccount()))
                .creditCardDTO(creditCardService.mapToDto(newCreditCard))
                .build();
    }
